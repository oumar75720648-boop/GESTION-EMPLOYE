...
const [demandesEnAttente] = useState(0);
...
return ( <div className="flex flex-col gap-6 px-4 sm:px-6 md:px-8 lg:px-12"> <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4"> <div> <h1 className="text-2xl font-bold text-gray-800">Tableau de bord</h1>
{loadingUser ? ( <p className="text-gray-600 mt-1">Chargement...</p>
) : user ? ( <p className="text-black mt-1">
Bienvenue, <strong>{user.nom} {user.prenom}</strong> </p>
